const DokumentasiSection = ({ sectionLabel = 'DOKUMENTASI', organizationLabel = '', children }) => {
    return (
        <section id="dokumentasi-section" className="w-full px-7 md:px-10 lg:px-14 xl:px-16 pt-16 pb-12 bg-[#787474] scroll-mt-16 flex flex-col gap-6">
            <div id="dokumentasi-header-wrapper" className="w-full pt-6">
                <header id="dokumentasi-header" className="w-full text-center font-bold flex flex-col gap-2 text-white">
